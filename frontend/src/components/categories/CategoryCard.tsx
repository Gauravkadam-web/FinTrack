        ...
        {!isSystem ? (
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-1.5 rounded-lg text-slate-400 hover:text-foreground hover:bg-surface-100 transition-colors cursor-pointer"
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-rose-500 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors cursor-pointer"
