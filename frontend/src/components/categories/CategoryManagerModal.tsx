          ...
          <div className="space-y-2 max-h-80 overflow-y-auto pr-1">
            {categories.map((cat) => {
              ...
              return (
                <div
                  key={cat.id}
                  className="flex items-center justify-between p-3 rounded-xl bg-surface-50 border border-slate-800 hover:border-slate-700/80 transition-colors"
                >
                  {isEditing ? (
                    ...
                    <>
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-surface-100 flex items-center justify-center text-primary font-bold text-xs">
        ...
        message={
          <div>
            ...
            {deleteExpenseCount !== null && deleteExpenseCount > 0 ? (
              <p className="text-amber-400 text-xs bg-amber-950/40 p-2.5 rounded-xl border border-amber-500/30">
