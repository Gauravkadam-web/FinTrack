  ...
  if (!snapshot) {
    return (
      <TiltCard maxTilt={8} scaleOnHover={1.02} className="h-full">
        <div className="glass-card rounded-2xl p-4 sm:p-5 flex flex-col justify-between border border-dashed border-border hover:border-slate-400 dark:hover:border-slate-600 transition-colors group h-full bg-surface-50">
          ...
          <button
            onClick={onSetBudget}
            className="text-xs text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 font-bold self-start inline-flex items-center gap-1 hover:underline pt-1 cursor-pointer"
          >
    ...
    <TiltCard maxTilt={8} scaleOnHover={1.02} className="h-full">
      <div className="glass-card rounded-2xl p-4 sm:p-5 flex flex-col justify-between border border-border h-full bg-surface-50">
        ...
        <div className="flex items-center justify-between gap-1.5 mb-1.5">
          <Link
            href="/budgets"
            className="text-[11px] uppercase tracking-wider font-bold text-slate-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors truncate flex items-center gap-1"
          >
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              onClick={onSetBudget}
              className="p-1 rounded-md text-slate-400 hover:text-foreground hover:bg-surface-100 transition-colors cursor-pointer"
