      ...
      {isLoading ? (
        ...
        <div className="glass-card rounded-2xl p-4 sm:p-5 flex flex-col justify-between border border-slate-800/80 hover:border-slate-700/80 transition-all h-full">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <div className="w-7 h-7 rounded-lg bg-primary/10 text-primary-400 flex items-center justify-center border border-primary/20">
            ...
            <div className="mt-0.5 text-[11px] font-semibold truncate">
              {comparison?.percentage_change !== null && comparison?.percentage_change !== undefined ? (
                Number(comparison.percentage_change) > 0 ? (
                  ...
                  <span className="text-slate-400">0% vs last mo.</span>
                )
              ) : (
