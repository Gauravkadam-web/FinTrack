...
import { getCategoryVisuals, ReceiptIcon } from "@/components/ui/Icons";
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className={`w-8 h-8 rounded-lg ${visuals.bgLight} border ${visuals.borderLight} flex items-center justify-center ${visuals.color} shrink-0 shadow-xs`}>
